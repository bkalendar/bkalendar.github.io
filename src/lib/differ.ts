...
export function diffResolvedEntries(oldEntries: EntryResolved[], newEntries: EntryResolved[]): Pair<EntryResolved>[] {
    ...
    return Object.values(result).sort((a, b) => {
        ...
        if (extractA.wday == extractB.wday) return extractA.start - extractB.start;
