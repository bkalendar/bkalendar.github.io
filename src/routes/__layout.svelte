...
>
  <nav class="h-16 flex items-center justify-end mr-5 sm:mb-16">
    <ul class="flex space-x-5">
      ...
      <li>
        <!-- prettier-ignore -->
        <svg class="w-5 h-5" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 30 30" enable-background="new 0 0 30 30" xml:space="preserve">
