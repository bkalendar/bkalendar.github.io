...
{
	if (region.a7.aA === region.br.aA)
	{
		return 'on line ' + region.a7.aA;
	}
	return 'on lines ' + region.a7.aA + ' through ' + region.br.aA;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bw: fragment, bz: host, bL: path, bN: port_, bR: protocol, bS: query};
	});
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{P: $elm$core$Array$empty, aS: '', aV: $elm$core$Maybe$Nothing},
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return $elm$core$String$isEmpty(record.cj) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3($elm$core$Dict$insert, record.cE, record.cj, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return $elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var $rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_v0) {
	...
	return {bn: charset, ck: finalDeclarations, bA: imports, bJ: namespaces};
};
...
var $rtfeldman$elm_css$ElmCssVendor$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {ab: charsProcessed, ah: hash, W: seed, am: shift};
	});
...
var $rtfeldman$elm_css$ElmCssVendor$Murmur3$finalize = function (data) {
	var acc = (!(!data.ah)) ? (data.W ^ A2(
		...
		A2(
			...
			15,
			A2($rtfeldman$elm_css$ElmCssVendor$Murmur3$multiplyBy, $rtfeldman$elm_css$ElmCssVendor$Murmur3$c1, data.ah)))) : data.W;
	var h0 = acc ^ data.ab;
...
var $rtfeldman$elm_css$ElmCssVendor$Murmur3$hashFold = F2(
	function (c, data) {
		...
		if (_v0 === 24) {
			...
			return {ab: data.ab + 1, ah: res, W: data.W, am: data.am + 8};
		}
	});
...
var $rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_v0) {
	...
	var declarations = $rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2($elm$core$List$concatMap, $rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {bn: charset, ck: declarations, bA: imports, bJ: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {bn: $elm$core$Maybe$Nothing, bA: _List_Nil, bJ: _List_Nil, b_: snippets};
};
...
var $author$project$Main$GotEvent = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Timetable$Timetable = F4(
	function (semester, from, to, entries) {
		return {co: entries, cq: from, cP: semester, cU: to};
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {bo: col, ci: contextStack, bO: problem, bX: row};
	});
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.b, s.bX, s.bo, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			0,
			{bo: newCol, f: s.f, g: s.g, b: newOffset, bX: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {bo: s.bo + (newOffset - s.b), f: s.f, g: s.g, b: newOffset, bX: s.bX, a: s.a};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			$elm$parser$Parser$Advanced$AddRight,
			$elm$parser$Parser$Advanced$Empty,
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bX, s.bo, x, s.f));
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.bX, s.bo - (floatOffset + s.b), invalid, s.f));
		} else {
...
var $author$project$Timetable$TimetableEntry = F8(
	function (id, name, group, wday, start, end, room, weeks) {
		return {br: end, cr: group, cu: id, cE: name, cM: room, a7: start, ba: wday, b7: weeks};
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{bo: col, f: s0.f, g: s0.g, b: offset, bX: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.bX, s.bo, s);
	};
};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.bX, s.bo, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $author$project$Timetable$weekParser = A2(
						...
						A2(
							...
							$elm$parser$Parser$succeed(
								$elm$parser$Parser$Loop(
									_Utils_Tuple2(
										index + 1,
										A2($elm$core$List$cons, index, result)))),
...
var $author$project$Timetable$parser = function () {
	var cellChomper = $elm$parser$Parser$chompWhile(
		function (c) {
			return c !== '\t';
		});
	return A2(
		...
		A2(
					...
					A2(
						...
						A2(
							...
							A2(
								...
								A2(
									$elm$parser$Parser$keeper,
									$elm$parser$Parser$succeed($author$project$Timetable$TimetableEntry),
									A2(
										$elm$parser$Parser$ignorer,
										$elm$parser$Parser$getChompedString(cellChomper),
										$elm$parser$Parser$symbol('\t'))),
								A2(
									$elm$parser$Parser$ignorer,
									A2(
			...
			A2(
				...
				A2(
					...
					cellChomper),
				$elm$parser$Parser$symbol('\t'))),
		$author$project$Timetable$weekParser);
}();
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {bo: col, bO: problem, bX: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bX, p.bo, p.bO);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{bo: 1, f: _List_Nil, g: 1, b: 0, bX: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Timetable$parse = A2(
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								$elm$parser$Parser$ignorer,
								$elm$parser$Parser$succeed($author$project$Timetable$Timetable),
								$elm$parser$Parser$chompUntil('Học kỳ ')),
							$elm$parser$Parser$token('Học kỳ ')),
						A2(
							$elm$parser$Parser$ignorer,
							$elm$parser$Parser$int,
							$elm$parser$Parser$token(' Năm học '))),
					A2(
						$elm$parser$Parser$ignorer,
						$elm$parser$Parser$int,
					...
					return $elm$parser$Parser$oneOf(
						_List_fromArray(
							[
								...
								$elm$parser$Parser$ignorer,
								$elm$parser$Parser$succeed(
									$elm$parser$Parser$Loop(entries)),
								$elm$parser$Parser$symbol('\n')),
								A2(
								$elm$parser$Parser$map,
								function (entry) {
								...
								$author$project$Timetable$parser),
								$elm$parser$Parser$succeed(
								$elm$parser$Parser$Done(entries))
							]));
				}))),
...
var $author$project$Converter$week33Local = 1629046800000;
var $author$project$Converter$timetableEntryToEvent = F2(
	function (uuid, entry) {
		var toPosix = F3(
			function (wday, period, week) {
				return $elm$time$Time$millisToPosix((($author$project$Converter$week33Local + (week * 604800000)) + ((wday - 2) * 86400000)) + ((period + 5) * 3600000));
			});
		var firstWeek = A2(
			$elm$core$Maybe$withDefault,
			0,
		...
		return {
			...
			cK: A2(
				$elm$core$List$map,
				A2(toPosix, entry.ba, entry.a7),
				entry.b7),
			a7: A3(toPosix, entry.ba, entry.a7, firstWeek),
			cQ: entry.cE,
			cX: uuid
		};
	});
...
var $author$project$Converter$timetableToEvents = F2(
	function (toMsg, _v0) {
		var entries = _v0.co;
				...
				function (entry) {
					return A2(
						...
						A2(
							$elm$random$Random$map,
							function (uuid) {
								return A2($author$project$Converter$timetableEntryToEvent, uuid, entry);
							},
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var raw = msg.a;
				var newResult = $author$project$Timetable$parse(raw);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{aS: raw, aV: newResult}),
			...
			case 1:
				...
				return _Utils_Tuple2(
					...
					A2($author$project$Converter$timetableToEvents, $author$project$Main$GotEvent, timetable));
			default:
				var event = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							P: A2($elm$core$Array$push, event, model.P)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Event$monthToInt = function (month) {
	switch (month) {
		case 0:
			return 1;
		case 1:
...
var $author$project$Event$toDate = function (posix) {
	var dttm = A2(
		$elm$core$Basics$composeL,
				...
				_List_fromArray(
					[
						...
						[
							...
							$author$project$Event$monthToInt),
...
var $author$project$Event$toVEvent = function (event) {
	return 'BEGIN:VEVENT' + ('\nUID:' + ($danyx23$elm_uuid$Uuid$toString(event.cX) + ('\nDTSTAMP:20210815T200000' + ('\nSUMMARY:' + (event.cQ + ('\nDESCRIPTION:' + (event.cl + ('\nLOCATION:' + (event.cA + ('\nDTSTART:' + ($author$project$Event$toDate(event.a7) + ('\nDTEND:' + ($author$project$Event$toDate(event.br) + ('\nRDATE:' + (A2(
		$elm$core$String$join,
		',',
		A2($elm$core$List$map, $author$project$Event$toDate, event.cK)) + '\nEND:VEVENT')))))))))))))));
};
var $author$project$Event$toCalendar = function (events) {
	return 'BEGIN:VCALENDAR\nVERSION:2.0\nPRODID:-//bkalendar//Google Calendar v1.0/VI\n' + (A2(
		$elm$core$String$join,
		'\n',
		A2($elm$core$List$map, $author$project$Event$toVEvent, events)) + '\nEND:VCALENDAR');
};
var $author$project$Main$viewEvents = function (events) {
	var downloadLink = 'data:text/calendar,' + $elm$url$Url$percentEncode(
		$author$project$Event$toCalendar(
			$elm$core$Array$toList(events)));
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Html$Styled$Attributes$href(downloadLink),
						$rtfeldman$elm_css$Html$Styled$Attributes$download('export')
					]),
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Tải về')
					])),
				A2(
...
var $author$project$Main$viewTimetable = function (timetable) {
	return A2(
		...
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$text(
				'Học kỳ ' + $elm$core$String$fromInt(timetable.cP + (10 * (timetable.cq % 100)))),
				A2(
				$rtfeldman$elm_css$Html$Styled$button,
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Events$onClick(
						$author$project$Main$Convert(timetable))
					]),
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Convert')
					]))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Main$GotInput),
				...
				if (_v0.$ === 1) {
					...
					return A2(
						...
						_List_fromArray(
							[
								$author$project$Main$viewTimetable(timetable),
								(!_Utils_eq(
								$elm$core$List$length(timetable.co),
								$elm$core$Array$length(model.P))) ? $rtfeldman$elm_css$Html$Styled$text('') : $author$project$Main$viewEvents(model.P)
							]));
				}
			}()
			]));
